...
struct VectorTest :testing ::Test {
	...
	void SetUp()
	{
		vec4_1 = altertum::vector4::vector4(0, 0, 0, 0);
		vec4_2 = altertum::vector4::vector4(0, 0, 0, 0);
		vec3_1 = altertum::vector3::vector3(0, 0, 0);
		vec3_2 = altertum::vector3::vector3(0, 0, 0);
		vec2_1 = altertum::vector2::vector2(0, 0);
		vec2_2 = altertum::vector2::vector2(0, 0);
	}
	void TearDown()
	{
...
/*Test fixtures
	...
	//vector2: 1 constructor, equals operator
...
TEST_F(VectorTest, vecFunctions)
{
	...
	Vector2 vec2 = altertum::vector2::vector2(110.0f, 1000.0f);
	Vector3 vec3 = altertum::vector3::vector3(vec2);
	Vector4 vec4 = altertum::vector4::vector4(vec3);
