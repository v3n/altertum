...
#define ALTERTUM_VERSION_STRING ("altertum v" \
 		ALTERTUM_VERSION_MAJOR "." \
 		ALTERTUM_VERSION_MINOR "." \
 		ALTERTUM_VERSION_PATCH "-" \
 		ALTERTUM_VERSION_KEYWORD " " \
 		ALTERTUM_BUILD_TYPE)
...
#define ALTERTUM_PLATFORM_NACL       0
